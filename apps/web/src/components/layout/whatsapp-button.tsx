...
export function WhatsAppButton({ phoneNumber }: { phoneNumber: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-110 hover:shadow-xl md:bottom-6 md:right-6"
    >
